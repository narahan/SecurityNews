	...
	(function (_O) {
		...
		_O.Event = {
			...
			set: function(){
				...
				var os;
				os = $('#wrap .tab, .t_body .tr');
				this.setObjAddEvent(os);
			...
			onClick: function(o, e){
				...
				if(o.hasClass('tab')){
				...
				}else if(o.hasClass('tr')){
					// console.log('o', o.children('div:last-child'))
					var url, title;
					url = o.attr('url');
					title = o.children('div:last-child');
					...
					window.open(url, title, width, height, left, top , 'scrollbars=yes, resizable=yes');;
				}
			}
		};
		_O.Data = {
